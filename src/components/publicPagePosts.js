...
class PublicPagePosts extends Component{
    constructor(props){
        super(props);
        // this.state = {
        //     images_src :
    ...
    UNSAFE_componentWillMount = async () => {
        ...
        //var images = await this.props.user.methods.getAuthorByAddr(this.props.match.params.id).call()
        //var images = await this.props.posting.methods.getPostsByAddr(this.props.addr).call()
        // console.log(images)
